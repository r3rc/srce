...
export const serveCmd = defineCommand({
    meta: { description: "Start the registry HTTP server" },
    args: {
        port: { type: "string", description: "Port to listen on", default: "4873" },
        data: { type: "string", description: "Data directory", default: "./data" }
    },
    async run({ args }) {
